...
using MageeSoft.Paradox.Clausewitz.Save.Cli.Services.Games.CrusaderKings3;
using MageeSoft.Paradox.Clausewitz.Save.Cli.Services.Games.HeartsOfIron4;
using MageeSoft.Paradox.Clausewitz.Save.Cli.Services.Games.Stellaris;
using MageeSoft.Paradox.Clausewitz.Save.Cli.Services.Games.Victoria3;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Hosting;
using Microsoft.Extensions.Logging;

namespace MageeSoft.Paradox.Clausewitz.Save.Cli;
...
public class Program
{
    public static async Task<int> Main(string[] args)
    {
        ...
        versionCommand.SetHandler(() =>
        {
            ...
            Console.WriteLine($"MageeSoft.Paradox.Clausewitz.Save.Cli v{version}");
        });
