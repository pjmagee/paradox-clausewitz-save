...
public partial class AgreementTerms
{
    ...
    /// </summary>
    public ImmutableDictionary<string, string> DiscreteTerms { get;set; } = ImmutableDictionary<string, string>.Empty;

    /// <summary>
    /// Gets or sets the resource terms.
    /// </summary>
    public ImmutableDictionary<string, float> ResourceTerms { get;set; } = ImmutableDictionary<string, float>.Empty;
