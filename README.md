...
- `StellarisSaveParser` - Core parsing functionality
- `StellarisSaveParser.Reader` - High-level API for reading save files
- `StellarisSaveParser.Tests` - Unit tests and test data
